...
# o A link to the live site: https://csrei.onrender.com/
# o Usage instructions, use the following credentials to authenticate
# and to see restricted pages on the site:
# email: "carmensanchezrei@gmail.com", password: "pwd789" Admin Account
# or email: "jsparrow@rei.com", password: "pwd233"
...
# o in listing using createSlice, createAsyncThunk and axios
# o Using React, { useState, useEffect } for state management and effects
# o Using react-redux tollkit { useSelector, useDispatch } for managing 
#   MongoDB/API calls in auth,crm using createSlice, createAsyncThunk and fetch
#   to manage API calls across the site
# o Using JWT to generate a token for the session on the backend with an 
# exiration of 1 hour. 
# o The App.jsx uses refreshToken to catch the expired tokens every 5 minutes.
